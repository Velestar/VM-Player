...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --arch=arm --target-os=darwin --cc=/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --as='gas-preprocessor/gas-preprocessor.pl /Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc' --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.3.sdk --cpu=cortex-a8 --extra-cflags='-arch armv7' --extra-ldflags='-arch armv7' --enable-neon --disable-debug --disable-armv5te --disable-encoders --extra-ldflags=-L/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.3.sdk/usr/lib/system
prefix=/usr/local
...
SRC_PATH="/Users/Beherith/projects/velestar/VMPlayer/src/ffmpeg"
SRC_PATH_BARE=/Users/Beherith/projects/velestar/VMPlayer/src/ffmpeg
CC_IDENT=gcc 4.2.1 (GCC) (Apple Inc. build 5666) (dot 3)
ARCH=arm
...
LN_S=ln -sf
STRIP=strip -x
CPPFLAGS= --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.3.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE
CFLAGS= -arch armv7 -mcpu=cortex-a8 -std=c99 -mdynamic-no-pic -fomit-frame-pointer -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -O3 -fno-math-errno -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -arch armv7 -mcpu=cortex-a8 -mdynamic-no-pic
CC_O=-o $@
LDFLAGS= -arch armv7 -L/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.3.sdk/usr/lib/system --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS4.3.sdk -Wl,-dynamic,-search_paths_first
...
libavutil_VERSION=51.9.0
libavutil_VERSION_MAJOR=51
libavfilter_VERSION=2.18.0
