...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=i386 --target-os=darwin --cc=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc --sysroot=/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.0.sdk --extra-cflags='-arch i386' --extra-ldflags='-arch i386' --disable-encoders --disable-debug --disable-mmx --extra-ldflags=-L/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.0.sdk/usr/lib/system
prefix=/usr/local
...
CC_IDENT=llvm-gcc 4.2.1 (LLVM build 2336.1.00)
ARCH=x86
...
LN_S=ln -sf
STRIP=strip -x
CPPFLAGS= --sysroot=/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.0.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE
CFLAGS= -arch i386  -std=c99 -mdynamic-no-pic -fomit-frame-pointer -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -arch i386  -mdynamic-no-pic
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -arch i386 -L/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.0.sdk/usr/lib/system --sysroot=/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.0.sdk -Wl,-dynamic,-search_paths_first
...
HOSTCC=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc
...
LAVF_TESTS=aiff alaw asf au avi caf dpx dv_fmt ffm flv_fmt gxf mkv mmf mov mpg mulaw mxf mxf_d10 nut ogg pixfmt rm rso sox swf ts voc voc_s16 wav wtv yuv4mpeg 
